...
cd $HOME
git clone https://github.com/saeedsaeedi2898/ss2244.git
cd ss2244
chmod +x beyond.sh
./beyond.sh install
...
```sh
cd $HOME && git clone https://github.com/saeedsaeedi2898/ss2244.git && cd ss2244 && chmod +x beyond.sh && ./beyond.sh install && ./beyond.sh
```
